...
namespace Q3 {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class PersonDataTable : global::System.Data.TypedTableBase<PersonRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public PersonRow AddPersonRow(string First_Name, string Last_Name, string Gender, System.DateTime Birth_Date) {
            ...
            public System.DateTime Birth_Date {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'Birth_Date\' in table \'Person\' is DBNull.", e);
                    }
                }
                set {
...
namespace Q3.Database1DataSet1TableAdapters {
    ...
    public partial class PersonTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Person] WHERE (([ID] = @Original_ID) AND ((@IsNull_First_Name = 1 AND [First_Name] IS NULL) OR ([First_Name] = @Original_First_Name)) AND ((@IsNull_Last_Name = 1 AND [Last_Name] IS NULL) OR ([Last_Name] = @Original_Last_Name)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Birth_Date = 1 AND [Birth_Date] IS NULL) OR ([Birth_Date] = @Original_Birth_Date)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Person] ([First_Name], [Last_Name], [Gender], [Birth_Date]) VA" +
                "LUES (@First_Name, @Last_Name, @Gender, @Birth_Date);\r\nSELECT ID, First_Name, La" +
                "st_Name, Gender, Birth_Date FROM Person WHERE (ID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Person] SET [First_Name] = @First_Name, [Last_Name] = @Last_Name, [Gender] = @Gender, [Birth_Date] = @Birth_Date WHERE (([ID] = @Original_ID) AND ((@IsNull_First_Name = 1 AND [First_Name] IS NULL) OR ([First_Name] = @Original_First_Name)) AND ((@IsNull_Last_Name = 1 AND [Last_Name] IS NULL) OR ([Last_Name] = @Original_Last_Name)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)) AND ((@IsNull_Birth_Date = 1 AND [Birth_Date] IS NULL) OR ([Birth_Date] = @Original_Birth_Date)));
SELECT ID, First_Name, Last_Name, Gender, Birth_Date FROM Person WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Q3.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, First_Name, Last_Name, Gender, Birth_Date FROM dbo.Person";
        ...
        public virtual int Delete(int Original_ID, string Original_First_Name, string Original_Last_Name, string Original_Gender, global::System.Nullable<global::System.DateTime> Original_Birth_Date) {
        ...
        public virtual int Insert(string First_Name, string Last_Name, string Gender, global::System.Nullable<global::System.DateTime> Birth_Date) {
            if ((First_Name == null)) {
        ...
        public virtual int Update(string First_Name, string Last_Name, string Gender, global::System.Nullable<global::System.DateTime> Birth_Date, int Original_ID, string Original_First_Name, string Original_Last_Name, string Original_Gender, global::System.Nullable<global::System.DateTime> Original_Birth_Date, int ID) {
            if ((First_Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string First_Name, string Last_Name, string Gender, global::System.Nullable<global::System.DateTime> Birth_Date, int Original_ID, string Original_First_Name, string Original_Last_Name, string Original_Gender, global::System.Nullable<global::System.DateTime> Original_Birth_Date) {
            return this.Update(First_Name, Last_Name, Gender, Birth_Date, Original_ID, Original_First_Name, Original_Last_Name, Original_Gender, Original_Birth_Date, Original_ID);
        }
    }
